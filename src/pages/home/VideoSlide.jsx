    ...
    return (
      <div>
        <Slider {...settings}>
          <div>
          <div style={display}>
            <embed src="./img/rb8jtakrisiz0xtsffwi.mp4" type="video/mp4" style={{width: "1700px", height: "325px"}}/>
            <div style={display2}>
            <div>
          ...
          <div>
          <div style={display}>
            <embed src="./img/yja2ld5fnolhsixj3xxw.mp4" type="video/mp4" style={{width: "1800px", height: "325px"}}/>
          <div style={display2}>
          ...
          <div>
          <div style={display}>
            <embed src="./img/bsncmkwya3nectkensun.mp4" type="video/mp4" style={{width: "1000px", height: "325px"}}/>
          <div style={display2}>
          ...
          <div>
          <div style={display}>
            <embed src="./img/plfa6gdjihpdvr10rchl.mp4" type="video/mp4" style={{width: "1600px", height: "325px"}}/>
          <div style={display2}>
